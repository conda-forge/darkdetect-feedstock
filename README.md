...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/darkdetect-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12320&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/darkdetect-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `darkdetect` can be installed with:

```
conda install darkdetect
```

It is possible to list all of the versions of `darkdetect` available on your platform with:
